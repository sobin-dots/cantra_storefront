        ...
        <div className="flex gap-6">
          ...
          <nav className="hidden lg:flex items-center gap-7 text-xs font-medium text-body" aria-label="Main navigation">
            ...
            <div className="relative group py-4 -my-4">
              ...
              <div className="absolute top-full left-1/2 -translate-x-1/2 mt-0 w-48 bg-white rounded-xl shadow-xl border border-border opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 flex flex-col p-2">
                <Link href="/features/care-plan" className="px-4 py-2.5 hover:bg-[#E7EFEA] rounded-lg text-primary text-sm font-semibold transition-colors">
                  Care Plan
                </Link>
                <Link href="/features/emar" className="px-4 py-2.5 hover:bg-[#E7EFEA] rounded-lg text-primary text-sm font-semibold transition-colors">
                  eMAR
                </Link>
                <Link href="/features/staff-rota" className="px-4 py-2.5 hover:bg-[#E7EFEA] rounded-lg text-primary text-sm font-semibold transition-colors">
                  Staff & Rota
                </Link>
                <Link href="/features/compliances" className="px-4 py-2.5 hover:bg-[#E7EFEA] rounded-lg text-primary text-sm font-semibold transition-colors">
                  Compliances
                </Link>
              </div>
            </div>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden absolute top-full left-4 right-4 mt-2 p-5 bg-white rounded-2xl border border-border shadow-2xl z-40 space-y-3">
            <nav className="flex flex-col space-y-2 text-sm font-medium text-primary">
              ...
              <div className="p-2">
                <div className="font-semibold mb-2 text-xs uppercase tracking-wider text-body">Features</div>
